...
const UpdateListing = () => {
  ...
  if (images.length > 10) {
    setError("At most 10 images are allowed");
    setImages([]);
    return null;
  }
  ...
  useEffect(() => {
    axios.get(`/listings/get/${id}`).then((res) => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold text-center my-5">Update a Listing</h1>
